...
<body style="min-height: 100vh;">
    <div style="min-height: 100vh;" class="container mt-5">
        <div class="row w-100 d-flex justify-content-center align-items-center">
            <div class="col-12">
                <h1>Buat Generate File BARCODE</h1>
                <div class="d-flex">
                ...
                <form method="POST" action="./component/generatebarcode.php" class="w-100 " autocomplete="off">
                    <div class="mb-3 ">
                    ...
                    <div class="mb-3">
                        ...
                        <input required type="text" name="namafile" class="form-control" maxlength="17" id="namafile" placeholder="Masukan nama File">
            ...
            <div class="col-12  mt-5">
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <?php
                        $path = 'src/barcode/'; // Specify the folder path
                        ...
                        ?>
                                <tr>
                                    <td><?= $no++ ?></td>
                                    <td><?= $rs ?></td>
                                    <td><a href="./component/downloadfilebarcode.php?download=1&filename=<?= $rs ?>" >download</a></td>
                                </tr>
                        <?php }
                        } ?>
                    </tbody>
