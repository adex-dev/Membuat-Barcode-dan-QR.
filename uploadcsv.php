...
<body style="min-height: 100vh;">
    <div style="min-height: 100vh;" class="container mt-5">
        <div class="row w-100 d-flex justify-content-center align-items-center">
            <div class="col-12">
                <h1>Generate QR Via Upload</h1>
                <div class="d-flex">
                    <a href="index.php" class="btn btn-info mx-2">Create QR</a>
                    <a href="barcode.php" class="btn btn-info mx-2">Create Barcode</a>
                ...
                <form method="POST" action="./component/generatecsv.php" enctype="multipart/form-data" class="w-100 " autocomplete="off">
                    <div class="mb-3 ">
